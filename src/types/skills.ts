...
import { SKILLS_DATA } from '../data/skills-database';

// Re-export skill category type from resume types
...
export class SkillsDatabase {
   ...
   */
  findMultipleSkills(terms: string[]): (Skill | null)[] {
