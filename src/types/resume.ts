...
export interface ExtractedKeyword {
  term: string; // "React", "project management", "Agile"
  category: KeywordCategory;

  // Importance
  required: boolean; // Is this a must-have or nice-to-have?
  frequency: number; // How many times it appears
  weight: number; // Calculated importance score (0-100)

  // Context
  context?: string[]; // Sentences where keyword appears

  // Synonyms to match
  synonyms?: string[]; // ["React", "React.js", "ReactJS"]
}
