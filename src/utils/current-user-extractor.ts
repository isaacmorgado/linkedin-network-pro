...
export function extractCurrentUserFromDOM(): Partial<LinkedInPersonProfile> | null {
  try {
    ...
    console.error('[Uproot] Error extracting current user:', error);
    return null;
  }
}
...
function extractFromGlobalNav(): Partial<LinkedInPersonProfile> | null {
  try {
    ...
    console.error('[Uproot] Error extracting from global nav:', error);
    return null;
  }
}
...
function extractFromProfileDropdown(): Partial<LinkedInPersonProfile> | null {
  try {
    ...
    console.error('[Uproot] Error extracting from dropdown:', error);
    return null;
  }
}
...
function extractFromMetaTags(): Partial<LinkedInPersonProfile> | null {
  try {
    ...
    console.error('[Uproot] Error extracting from meta tags:', error);
    return null;
  }
}
...
function extractFromJSONLD(): Partial<LinkedInPersonProfile> | null {
  try {
    ...
    console.error('[Uproot] Error extracting from JSON-LD:', error);
    return null;
  }
}
...
function extractFromStorage(): Partial<LinkedInPersonProfile> | null {
  try {
    ...
    console.error('[Uproot] Error extracting from storage:', error);
    return null;
  }
}
...
export function getCurrentUserProfileUrl(): string | null {
  try {
    ...
    console.error('[Uproot] Error getting profile URL:', error);
    return null;
  }
}
...
export function getCurrentUserPhotoUrl(): string | null {
  try {
    ...
    console.error('[Uproot] Error getting photo URL:', error);
    return null;
  }
}
...
export function getCurrentUserPublicId(): string | null {
  try {
    ...
    console.error('[Uproot] Error getting public ID:', error);
    return null;
  }
}
