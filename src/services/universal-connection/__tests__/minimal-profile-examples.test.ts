...
describe('Minimal Profile Examples - Real World Scenarios', () => {
  it('Example 1: New User (only name + title)', async () => {
    ...
    expect(result.estimatedAcceptanceRate).toBe(0.12); // Pure cold outreach
    expect(result.reasoning).toContain('Low profile similarity (0.0%)');
