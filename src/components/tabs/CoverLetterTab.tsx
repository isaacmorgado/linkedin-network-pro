...
import type { JobDescriptionAnalysis } from '../../services/job-description-analyzer';
import type { ProfessionalProfile } from '../../types/resume';
import type { LinkedInJobData } from '../../services/linkedin-job-scraper';
import { generateCoverLetter } from '../../services/cover-letter-generator';
import {
...
function PreviewView({
  ...
  const scoreColor =
    coverLetter.atsScore >= 80
      ? '#4CAF50'
      : coverLetter.atsScore >= 65
      ? '#2196F3'
      : coverLetter.atsScore >= 50
      ? '#FF9500'
      : '#F44336';
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ fontSize: '12px', color: `${textColor}99`, margin: 0 }}>
              {coverLetter.wordCount} words • {coverLetter.tone} tone
            </p>
          </div>
          <div
            style={{
