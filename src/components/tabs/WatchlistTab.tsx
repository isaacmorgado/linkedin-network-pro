/**
 * Watchlist Tab
 * Shows saved people and companies for tracking
 */

import React, { useState } from 'react';
import { User, Briefcase, Trash2, ExternalLink, Loader2, BookmarkCheck, Building2, Bell, BellOff } from 'lucide-react';
import { useWatchlist } from '../../hooks/useWatchlist';
import type { WatchlistPerson, WatchlistCompany } from '../../types/watchlist';

type WatchlistView = 'people' | 'companies';
...
export function WatchlistTab() {
  ...
  const [activeView, setActiveView] = useState<WatchlistView>('people');
  ...
  const currentList = activeView === 'people' ? watchlist : companyWatchlist;
  ...
  if (isEmpty) {
    return (
      ...
      >
        {/* Tab Switcher */}
        <TabSwitcher activeView={activeView} onViewChange={setActiveView} peopleCount={watchlist.length} companyCount={companyWatchlist.length} />
...
function TabSwitcher({ activeView, onViewChange, peopleCount, companyCount }: TabSwitcherProps) {
  return (
    <div
      style={{
        padding: '16px',
