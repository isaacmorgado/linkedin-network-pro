...
function GenerateTab({ profile, onUpdate }: { profile: ProfessionalProfile; onUpdate: () => void }) {
  return (
    <div style={{ padding: '20px', textAlign: 'center' }}>
      <Sparkles size={48} strokeWidth={1.5} style={{ color: '#d1d5db', margin: '0 auto 16px auto' }} />
      <h3 style={{ fontSize: '16px', fontWeight: '600', color: '#1d1d1f', margin: '0 0 8px 0' }}>
        AI Resume Generator
      </h3>
      <p style={{ fontSize: '13px', color: '#6e6e73', margin: 0 }}>
        Coming soon: Paste job description and generate tailored resume
      </p>
    </div>
  );
}
